...
public:
	...
	void rotate_robot(double ang_z)
	{
...
//////////////////////////////////////////////////////////////////////		
		...
		if(pcl::computeCentroid(pclXYZ, centroid) > 5)
		{
